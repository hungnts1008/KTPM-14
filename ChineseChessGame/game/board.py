...
class BoardGame:
    def __init__(self):
        ...
        max_gap_height = WIN_HEIGHT // (self.rows + 2)
        max_gap_width = (WIN_WIDTH - WIN_WIDTH // 4 - 100) // (self.cols + 1)

        self.gap = min(max_gap_width, max_gap_height)
    ...
    def calculatePostion(self):
        ...
        self.x = 500
        self.y = (WIN_HEIGHT - self.height+100) / 2
